...
<head>
  ...
  <link href="<?php echo base_url();?>assets/home.css" rel="stylesheet" type="text/css" media="all" />
</head>
...
<body>
            ...
            <img src="<?php echo base_url();?>assets/images/slide1.jpg" alt="First slide">
                    ...
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
                              <span>Welcome to <strong><i>ShareYourStory</i></strong></span>
                            </h2>
                            <br>
                            <br>
                            <div class="">
 ...
 <div class="page" id="fquotes">
  ...
  <div id="footer-wrapper">
    <div id="footer" class="container" class="row">
